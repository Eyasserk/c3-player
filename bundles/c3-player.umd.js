(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs/operators'), require('kurento-utils-browser'), require('@angular/core'), require('rxjs'), require('@angular/platform-browser/animations'), require('@angular/material/slider')) :
    typeof define === 'function' && define.amd ? define('c3-player', ['exports', '@angular/common', 'rxjs/operators', 'kurento-utils-browser', '@angular/core', 'rxjs', '@angular/platform-browser/animations', '@angular/material/slider'], factory) :
    (factory((global['c3-player'] = {}),global.ng.common,global.rxjs.operators,global.kurentoUtilsBrowser,global.ng.core,global.rxjs,global.ng.platformBrowser.animations,global.ng.material.slider));
}(this, (function (exports,common,operators,kurentoUtilsBrowser,i0,rxjs,animations,slider) { 'use strict';
    ...
    var C3playerComponent = /** @class */ (function () {
        ...
        C3playerComponent.propDecorators = {
            ...
            imageSource: [{ type: i0.Input }],
            audioSource: [{ type: i0.Input }],
            wsUrl: [{ type: i0.Input }],
            totalDuration: [{ type: i0.Input }]
        };
